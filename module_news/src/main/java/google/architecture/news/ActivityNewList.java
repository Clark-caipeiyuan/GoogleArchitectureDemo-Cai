...
public class ActivityNewList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityNewsBinding = DataBindingUtil.setContentView(ActivityNewList.this,R.layout.activity_news);
//        NewsViewModel newsViewModel = new NewsViewModel(ActivityNews.this.getApplication());
        ...
        NewsViewModel newsViewModel =
                ViewModelProviders.of(ActivityNewList.this).get(NewsViewModel.class);
    ...
    NewsItemClickCallback girlItemClickCallback = new NewsItemClickCallback() {
        ...
        public void onClick(NewsData.ResultsBean fuliItem) {
            Toast.makeText(ActivityNewList.this, fuliItem.getTitle(), Toast.LENGTH_SHORT).show();
        }
    };
